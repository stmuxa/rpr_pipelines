...
def installPlugin(String osName, Map options)
{
    ...
    case 'Windows':
        ...
        dir('temp/install_plugin')
        {
            ...
            bat """
            msiexec /i "${options.pluginWinSha}.msi" /quiet /qn BLENDER_INSTALL_FOLDER="C:\\Program Files\\Blender Foundation\\Blender 2.81\\2.81" /L+ie ../../${options.stageName}.install.log /norestart
            """
