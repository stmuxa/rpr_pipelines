    ...
    case 'Windows':
      try {
            ...
            switch(tool) {
              ...
              String post = python3("..\\..\\cis_tools\\RenderSceneJob\\send_post.py --django_ip \"http://172.30.23.112:7077/jenkins_post_form/\" --build_number ${currentBuild.number} --status ${currentBuild.result} --id ${id}")
              print post
            }
     break;
    case 'OSX':
