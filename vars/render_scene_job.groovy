	...
	switch(osName) {
		...
		case 'OSX':
			...
			try {
				...
				archiveArtifacts "Output/*"
				sh """
				 python3 "../../cis_tools/RenderSceneJob/send_post.py" --django_ip \"https://render.cis.luxoft.com//jenkins_post_form/\" --jenkins_job \"RenderSceneJob\" --build_number ${currentBuild.number} --status ${currentBuild.result} --id ${id}
				"""
			}
			break;
